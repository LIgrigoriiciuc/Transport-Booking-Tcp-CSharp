...
public class UserRepository : GenericRepository<long, User>
{
    ...
    protected override string BuildInsertSql() =>
        "INSERT INTO users (username, password, fullName, officeId) VALUES (@username, @password, @fullName, @officeId)";
    ...
    protected override string BuildUpdateSql() =>
        "UPDATE users SET username = @username, password = @password, fullName = @fullName, officeId = @officeId WHERE id = @id";
