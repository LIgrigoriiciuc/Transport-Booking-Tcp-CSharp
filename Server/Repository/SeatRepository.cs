...
public class SeatRepository : GenericRepository<long, Seat>
{
    ...
    protected override string BuildInsertSql() =>
        "INSERT INTO seats (number, isReserved, trip_id, reservation_id) VALUES (@number, @isReserved, @tripId, @reservationId)";
    ...
    protected override string BuildUpdateSql() =>
        "UPDATE seats SET number = @number, isReserved = @isReserved, trip_id = @tripId, reservation_id = @reservationId WHERE id = @id";
    ...
    protected override Seat MapResultSetToEntity(SqliteDataReader reader)
    {
        ...
        return new Seat(id, number, isReserved, tripId, reservationId);
    }
}